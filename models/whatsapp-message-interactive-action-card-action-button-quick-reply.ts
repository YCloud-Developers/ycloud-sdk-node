 ...
 *
 * @export
 * @interface WhatsappMessageInteractiveActionCardActionButtonQuickReply
 */
export interface WhatsappMessageInteractiveActionCardActionButtonQuickReply {
    /**
     ...
     * @type {string}
     * @memberof WhatsappMessageInteractiveActionCardActionButtonQuickReply
     */
    'title'?: string;
    /**
