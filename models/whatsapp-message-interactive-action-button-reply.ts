 ...
 * 
 * @export
 * @interface WhatsappMessageInteractiveActionButtonReply
 */
export interface WhatsappMessageInteractiveActionButtonReply {
    /**
     * Button title. It cannot be an empty string and must be unique within the message. Emojis are supported, markdown is not.
     * @type {string}
     * @memberof WhatsappMessageInteractiveActionButtonReply
     */
    'title'?: string;
    /**
