 ...
 * @export
 * @interface WhatsappBusinessAccountPage
 */
export interface WhatsappBusinessAccountPage {
    /**
     * An array containing WhatsApp Business Account objects.
     * @type {Array<WhatsappBusinessAccount>}
     * @memberof WhatsappBusinessAccountPage
     */
    'items'?: Array<WhatsappBusinessAccount>;
    /**
